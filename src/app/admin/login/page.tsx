  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-6">
      <form onSubmit={submit}>
        <Card className="w-full max-w-sm gap-4 p-8">
          <h1 className="text-lg font-semibold tracking-tight">供货订购 · 商家登录</h1>
          <p className="text-sm text-muted-foreground">仅供货方使用，客户无需登录</p>
